            ...
            <div className="settings-modal related-case-modal" onClick={e => e.stopPropagation()}>
                <div className="settings-header">
                    <div className="modal-title-wrapper" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <h2>تفاصيل القضية | Case Details</h2>
                    </div>
                ...
                <div className="settings-content">
                    ...
                    <div className="settings-section">
                        <h3>
                            <FileText size={14} style={{ display: 'inline', marginLeft: '5px' }} />
                            الملخص | Abstract
                        </h3>
                        <div className="case-abstract-box" style={{
                            ...
                            <p>{caseData.preview || caseData.abstract || "No abstract available for this case."}</p>
                        </div>
                    </div>
                    ...
                    <div className="settings-section">
                        <h3>
                            <BookOpen size={14} style={{ display: 'inline', marginLeft: '5px' }} />
