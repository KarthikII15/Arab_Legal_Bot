...
LEGAL_PRINCIPLES = [
    ...
    # ── Intellectual Property Principles ──────────────────────────
    {
        ...
        "name_ar": "حقوق الملكية الفكرية",
        "name_en": "Intellectual Property Rights",
        "description_ar": "حماية حقوق الطبع والنشر والعلامات التجارية وبراءات الاختراع",
        "patterns": [
            r"حقوق الملكية الفكرية",
            r"حقوق الطبع والنشر",
            r"حقوق النشر",
            r"حقوق المؤلف",
            r"انتهاك حقوق",
    ...
    {
        "id": "indirect_liability",
        "name_ar": "المسؤولية غير المباشرة",
        "name_en": "Indirect / Vicarious Liability",
        "description_ar": "مسؤولية الطرف الذي يسهل أو يساهم في الانتهاك دون ارتكابه مباشرة",
        "patterns": [
            r"المسؤولية غير المباشرة",
            r"مسؤولية.*غير مباشرة",
            r"المسؤولية التبعية",
            r"مزود.*خدم.*إنترنت",
            r"ISP",
            r"تسهيل الانتهاك",
            r"ساهم في الانتهاك",
            r"يسهل.*انتهاك",
            r"إجراءات كافية لردع",
            r"لم.*تتخذ إجراءات"
        ]
    },
    {
        "id": "safe_harbor",
        "name_ar": "الملاذ الآمن لمزودي الخدمات",
        "name_en": "Safe Harbor Doctrine",
        "description_ar": "حماية مزودي خدمات الإنترنت من المسؤولية إذا اتخذوا إجراءات معقولة لمكافحة الانتهاكات",
        "patterns": [
            r"الملاذ الآمن",
            r"حماية مزود.*الخدم",
            r"إخطار.*وإزالة",
            r"إنهاء.*الخدمة.*عن.*المنتهك",
            r"قطع الخدمة",
            r"إخطارات.*انتهاك",
            r"DMCA",
            r"safe harbor"
