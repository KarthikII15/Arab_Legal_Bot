...
CASE_TYPES = {
    ...
    "intellectual_property": {
        ...
        "anchor": "نزاع حول حقوق الملكية الفكرية، انتهاك حقوق الطبع والنشر، علامة تجارية، براءة اختراع، قرصنة رقمية، حقوق المؤلف، مسؤولية مزودي خدمات الإنترنت عن انتهاكات المستخدمين.",
        "keywords": [
            "ملكية فكرية", "حقوق الطبع والنشر", "حقوق النشر", "حقوق المؤلف",
            "علامة تجارية", "براءة اختراع", "قرصنة", "انتهاك حقوق",
            "تحميل غير قانوني", "موسيقى", "أفلام", "مزود خدمة إنترنت",
            "copyright", "intellectual property", "infringement", "piracy",
            "trademark", "patent", "ISP", "DMCA"
        ]
    }
}
